...
macro_rules! uart_shared {
    ($USARTX:ident, $dmamux_rx:ident, $dmamux_tx:ident,
        tx: [ $(($PTX:ident, $TAF:expr, $GPIOTX:ident, $txi:expr),)+ ],
                ...
                fn setup(&self) {
                    ...
                    unsafe {
                        ...
                        gpio.pupdr.modify(|r, w| {
                            w.bits(r.bits() & !(0b11 << ($txi * 2)))
                        });

                        // Open drain output
                        gpio.otyper.modify(|r, w| {
                            w.bits(r.bits() | (0b1 << $txi))
                        });
                    }
                }
            }
...
tx: [
    (PA9, AltFunction::AF1, GPIOA, 9),
    (PB6, AltFunction::AF0, GPIOB, 6),
    (PC4, AltFunction::AF1, GPIOC, 4),
],
rx: [
...
uart_shared!(USART2, USART2_RX, USART2_TX,
    tx: [
        (PA2, AltFunction::AF1, GPIOA, 2),
        (PA14, AltFunction::AF1, GPIOA, 14),
        (PD5, AltFunction::AF0, GPIOD, 5),
    ],
    rx: [
        (PA3, AltFunction::AF1),
...
uart_shared!(USART3, USART3_RX, USART3_TX,
    tx: [
        (PA5, AltFunction::AF4, GPIOA, 5),
        (PB2, AltFunction::AF4, GPIOB, 2),
        (PB8, AltFunction::AF4, GPIOB, 8),
        (PB10, AltFunction::AF4, GPIOB, 10),
        (PC4, AltFunction::AF1, GPIOC, 4),
        (PC10, AltFunction::AF1, GPIOC, 10),
        (PD8, AltFunction::AF1, GPIOD, 8),
    ],
    rx: [
        (PB0, AltFunction::AF4),
        (PB9, AltFunction::AF4),
...
uart_shared!(LPUART, LPUART_RX, LPUART_TX,
    tx: [
        (PA2, AltFunction::AF6, GPIOA, 2),
        (PB11, AltFunction::AF1, GPIOB, 11),
        (PC1, AltFunction::AF1, GPIOC, 1),
    ],
    rx: [
        (PA3, AltFunction::AF6),
